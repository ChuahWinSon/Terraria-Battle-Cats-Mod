...
{
    public class TeacherBunbunAttack : ModProjectile
    {


        public override void SetStaticDefaults()
        {
            Main.projFrames[Projectile.type] = 3; // If the projectile has 4 frames
        }
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.timeLeft = 30; // Lasts for 10 frames (1/6 second)
