...
namespace TheBattleCats.Content.Projectiles.Minions
{
	...
	public class SanzoStaffBuff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[ModContent.ProjectileType<SanzoStaffMinion>()] > 0) {
	...
	public class SanzoStaffItem : ModItem
	{
		public override void SetStaticDefaults() {
		...
		public override void SetDefaults() {
			...
			Item.buffType = ModContent.BuffType<SanzoStaffBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ModContent.ProjectileType<SanzoStaffMinion>(); // This item creates the minion projectile
		}
	...
	public class SanzoStaffMinion : ModProjectile
	{
		public override void SetStaticDefaults() {
		...
		private bool CheckActive(Player owner) {
			if (owner.dead || !owner.active) {
				owner.ClearBuff(ModContent.BuffType<SanzoStaffBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<SanzoStaffBuff>())) {
		 ...
		 public override bool PreDraw(ref Color lightColor)
        {
			...
			Vector2 baseOffset = new Vector2(-40f, 0f); // move 10px right, 5px down
